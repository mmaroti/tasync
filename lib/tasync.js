...
(function() {
  ...
  function setTrace(value) { TASYNC_TRACE_ENABLE = value; }
  ...
  function delay(timeout, value) {
    ...
    setTimeout(function() { future.resolve(value); }, timeout);
    return future;
  }
  ...
  function UnwrapListener(callback) { this.callback = callback; }
  ...
  function throttle(func, limit) {
    ...
    return function() { return listener.schedule(func, this, arguments); };
  }
  ...
  function FutureJoin(first) {
    ...
    this.first = first;
    this.missing =
        first instanceof Future && first.state === STATE_LISTEN ? 1 : 0;
  }
